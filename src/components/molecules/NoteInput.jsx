    ...
    render() {
        ...
        return (
            <form className="note__form-input" onSubmit={this.onSubmitListener}>
                <input type="text" placeholder="Title" onChange={this.onTitleChangeListener} value={title} required />
                <p>{title.length}/50</p>
                <textarea placeholder="Write down here..." onChange={this.onBodyChangeListener} value={body} required />
